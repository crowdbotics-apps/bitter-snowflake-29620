...
## Project Structure
    ...
    ├── bitter_snowflake_29620  # Django project configurations
...
1. Clone this repo and `cd bitter_snowflake_29620`
...
2. Clone this repo and `cd bitter_snowflake_29620`
